...
export default function CarrouselV2({ items, render, intervalMs = 3000, follow }) {
  ...
  const [visible, setVisible] = useState(4); // par défaut desktop
  // breakpoints: mobile<640=1, tablette 640+=2, desktop 1024+=4
  const computeVisible = (w) => (w >= 1330 ? 4 : w >= 640 ? 3 : 1);
  ...
  return (
    <div className="carousel" role="region" aria-label="Carrousel">
      {/* 🔸 CHANGEMENT: viewport pour ResizeObserver */}
